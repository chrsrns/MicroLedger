package ph.chrsrns.microledger.ui.preferences
...
constructor(
    ...
    val transactionStatusPresentByDefault: LiveData<Boolean> =
        preferencesDataSource.transactionStatusPresentByDefault
    val transactionCodePresentByDefault: LiveData<Boolean> =
        preferencesDataSource.transactionCodePresentByDefault
    val transactionPayeePresentByDefault: LiveData<Boolean> =
        preferencesDataSource.transactionPayeePresentByDefault
    val transactionNotePresentByDefault: LiveData<Boolean> =
        preferencesDataSource.transactionNotePresentByDefault
    val transactionCurrenciesPresentByDefault: LiveData<Boolean> =
        preferencesDataSource.transactionCurrenciesPresentByDefault
    ...
    val postingAmountPresentByDefault: LiveData<Boolean> =
        preferencesDataSource.postingAmountPresentByDefault
    val postingCostPresentByDefault: LiveData<Boolean> =
        preferencesDataSource.postingCostPresentByDefault
    val postingAssertionPresentByDefault: LiveData<Boolean> =
        preferencesDataSource.postingAssertionPresentByDefault
    val postingAssertionCostPresentByDefault: LiveData<Boolean> =
        preferencesDataSource.postingAssertionCostPresentByDefault
    val postingCommentPresentByDefault: LiveData<Boolean> =
        preferencesDataSource.postingCommentPresentByDefault
    ...
    fun storeDecimalSeparator(separator: String) =
        preferencesDataSource.setDecimalSeparator(separator)
    ...
    fun storeCurrencyAmountSpacing(spacing: Boolean) =
        preferencesDataSource.setCurrencyAmountSpacing(spacing)

    fun storeTransactionStatusPresentByDefault(status: Boolean) =
        preferencesDataSource.setTransactionStatusPresentByDefault(status)

    fun storeTransactionCodePresentByDefault(code: Boolean) =
        preferencesDataSource.setTransactionCodePresentByDefault(code)

    fun storeTransactionPayeePresentByDefault(payee: Boolean) =
        preferencesDataSource.setTransactionPayeePresentByDefault(payee)

    fun storeTransactionNotePresentByDefault(note: Boolean) =
        preferencesDataSource.setTransactionNotePresentByDefault(note)
    ...
    fun storePostingAmountPresentByDefault(amount: Boolean) =
        preferencesDataSource.setPostingAmountPresentByDefault(amount)

    fun storePostingCostPresentByDefault(cost: Boolean) =
        preferencesDataSource.setPostingCostPresentByDefault(cost)

    fun storePostingAssertionPresentByDefault(assertion: Boolean) =
        preferencesDataSource.setPostingAssertionPresentByDefault(assertion)
    ...
    fun storePostingCommentPresentByDefault(comment: Boolean) =
        preferencesDataSource.setPostingCommentPresentByDefault(comment)

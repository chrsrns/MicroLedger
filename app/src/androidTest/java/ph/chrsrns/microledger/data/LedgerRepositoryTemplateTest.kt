...
class LedgerRepositoryTemplateTest {
    ...
    private fun createTestTemplate(id: String = "770e8400-e29b-41d4-a716-446655440002") =
        TransactionTemplate(
            firstLine = 0,
            lastLine = 0,
            id = id,
    ...
    @Test
    fun testReadTemplatesPopulation() =
        runTest {
    ...
    @Test
    fun testAddTemplateNoPreexistingComment() =
        runTest {
    ...
    @Test
    fun testAddTemplateCommentOnly() =
        runTest {
    ...
    @Test
    fun testUpdateTemplatePostings() =
        runTest {
            val uri = setupRepository(startingLedgerContent)
            val originalTemplate = repository.templates.value!![0]
            val updatedTemplate =
    ...
    @Test
    fun testUpdateTemplateNonExistentId() =
        runTest {
            val uri = setupRepository(startingLedgerContent)
    ...
    @Test
    fun testUpdateTemplatePreservesOtherTemplates() =
        runTest {
            val uri = setupRepository(startingLedgerContent)
            ...
            val originalFirst =
                repository.templates.value!!.find {
    ...
    @Test
    fun testUpdateTemplatePreservesTransactions() =
        runTest {
            val uri = setupRepository(startingLedgerContent)
            val originalTemplate = repository.templates.value!![0]
    ...
    @Test
    fun testUpdateTemplateMismatch() =
        runTest {
            val journalFile = File(tempFolder.root, "test.journal")
            val uri = setupRepository(startingLedgerContent)
            ...
            repository.updateTemplate(
                uri,
                originalTemplate.copy(name = "Should Fail"),
    ...
    @Test
    fun testDeleteTemplatePreservesOtherTemplates() =
        runTest {
            val uri = setupRepository(startingLedgerContent)
    ...
    @Test
    fun testDeleteTemplatePreservesTransactions() =
        runTest {
            val uri = setupRepository(startingLedgerContent)
    ...
    @Test
    fun testDeleteTemplateNonExistentId() =
        runTest {
            val uri = setupRepository(startingLedgerContent)
            val originalFileContents = repository.fileContents.value!!.joinToString("\n")
    ...
    @Test
    fun testDeleteTemplateMismatch() =
        runTest {
            val journalFile = File(tempFolder.root, "test.journal")
            val uri = setupRepository(startingLedgerContent)
    ...
    @Test
    fun testTemplateWithComplexPostings() =
        runTest {
            val uri = setupRepository(startingTransactionsPortion.trimMargin())
            val complexTemplate =
                TransactionTemplate(
    ...
    @Test
    fun testAddTemplateIgnoresInvalidPostingWithEmptyAccount() =
        runTest {
            val uri = setupRepository(startingTransactionsPortion.trimMargin())
            val templateWithInvalidPosting =
                TransactionTemplate(
                    firstLine = 0,
                    lastLine = 0,
    ...
    @Test
    fun testUpdateTemplateIgnoresInvalidPostingWithEmptyAccount() =
        runTest {
            val uri = setupRepository(startingLedgerContent)
            val originalTemplate = repository.templates.value!![0]
            val updatedTemplate =

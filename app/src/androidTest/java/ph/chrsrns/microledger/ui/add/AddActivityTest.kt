...
class AddActivityTest {
    ...
    fun canDoSimpleAdd() {
        ...
        composeRule.onNodeWithText(context.getString(R.string.amount)).assertIsDisplayed().performTextReplacement("10")
    ...
    @Test
    fun canRemovePostingFromBottomSheet() {
        fileManagerRule.configureAppWithFile("test.journal")
        composeRule.onNodeWithContentDescription(context.getString(R.string.add)).assertIsDisplayed().performClick()
        ...
        composeRule.onNodeWithText(context.getString(R.string.delete)).assertIsDisplayed().performClick()
        composeRule.onNodeWithText("Expenses:Food").assertDoesNotExist()
    }
